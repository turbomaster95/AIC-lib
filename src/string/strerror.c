...
char *strerror(int errnum) {
    switch (errnum) {
        ...
        case EAGAIN:           return "Try again"; /* Handles EWOULDBLOCK */
        ...
        /* errno.h (35-133) */
        case EDEADLK:          return "Resource deadlock would occur"; /* Handles EDEADLOCK */
        ...
        case EBADMSG:          return "Not a data message"; /* Handles EFSBADCRC */
        ...
        case EUCLEAN:          return "Structure needs cleaning"; /* Handles EFSCORRUPTED */
